...
// routes will work with the regular expression like if put ? after a character, it will make that character optional. For example, /user? will match both /user and /users. If you put + after a character, it will match one or more occurrences of that character. For example, /user+ will match /user, /users, /userr, etc. If you put * after a character, it will match zero or more occurrences of that character. For example, /user* will match /user, /users, /userr, /userrr, etc. If you put + after a character, it will match one or more occurrences of that character. For example, /user+ will match /user, /users, /userr, etc. If you put * after a character, it will match zero or more occurrences of that character. For example, /user* will match /user, /users, /userr, /userrr, etc. If you put () around a group of characters, it will create a capturing group. For example, /(user)+ will match /user, /users, /userr, etc. and will capture the matched group. If you put | between two groups of characters, it will create an alternation. For example, /(user|admin) will match /user and /admin.
